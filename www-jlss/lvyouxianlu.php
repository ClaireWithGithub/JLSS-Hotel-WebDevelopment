			...
			<div class="header-bottom-wrapper">
				<div class="twelve columns alpha" id="main-menu-wrapper">
                    ...
                    <li>
                        ...
                        <li><a class="active" href="lvyouxianlu.php">旅游线路</a></li>
	...
	<div id="content-wrapper">
		<div class="container">
			...
			<div id="slider">
				<ul>
                <?php 
			$sql="select * from xianlu where xianlu_title like '%荐%'";
			...
			$info=mysql_fetch_object($result);
				?>
					<li><a href="xianlu_details.php?id3=<?php echo $info->xianlu_id;?>">
						<img src="<?php echo $info->pic_xianlu_route;?>" alt="" /></a>
						<div class="slider-text">
							<h3><a href="xianlu_details.php?id3=<?php echo $info->xianlu_id;?>">
							<?php echo $info->xianlu_title;?></a></h3>
							<p><?php echo iconv_substr($info->xianlu_details,0,18,'gbk'); ?></p>
						</div>
					</li>
					<?php 
            $i++;
			...
			while($i<=$num){
			$info=mysql_fetch_object($result);
				?><a href="xianlu_details.php?id3=<?php echo $info->xianlu_id;?>">
					<img src="<?php echo $info->pic_xianlu_route;?>" alt="" width="350" height="233"/></a>
					<div class="sep4"></div>					
					<h3><a href="xianlu_details.php?id3=<?php echo $info->xianlu_id;?>">
					<?php echo $info->xianlu_title;?></a></h3>
                    <h4>线路内容：</h4>
                    <p><?php echo iconv_substr($info->xianlu_details,0,50,'gbk'); ?></p>
