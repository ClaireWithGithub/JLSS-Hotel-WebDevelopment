...
<div class="stat_list">
	<ul>
		<li  class="now"><a href="fendian_pay.php">查看</a></li>
		<li><a href="fendian_pay_insert1.php" >增加一条记录</a></li>
	</ul>
</div>
<?
...
<td><a href="fendian_pay_delete.php?id1=<?php echo $info->payway_id ;?> 
& id2=<?php echo $info->fendian_id ;?>">删除</a></td>
</tr>
<?php 
$i++;
}
...
<!--千万要注意超链接中双引号的位置，？前面，page=后面都没有"!!! -->
                                    <td><a href="fendian_pay.php?page=1"> 首页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="fendian_pay.php?page=<?php echo $last; ?>">上一页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="fendian_pay.php?page=<?php echo $next; ?>">下一页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="fendian_pay.php?page=<?php echo $pagecount; ?>">尾页</a></td>
</tr>
</table>
</body>
</html>
