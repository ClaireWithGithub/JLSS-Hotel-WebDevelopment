...
$sql1="select * from tuozhan where tuozhan_id=".$_GET[id];
$result1=mysql_query($sql1);
$info1=mysql_fetch_object($result1);

?>
<form method="POST" name="myform" action="tuozhan_update2.php" target="_self" enctype="multipart/form-data">
	
 <table cellpadding="2" cellspacing="1" class="table">
          <tr>
	      <td class="text"><span class="bi_tian">*</span>原路径：</td>
	      <td class="input">
         <?php echo $info1->pic_tuozhan_route; ?>
          </td>
	      </tr>
         <tr>
	    ...
	    <tr>
	      <td class="text"></td>
           ...
           <input type="hidden" name="update1" value="<?php echo $info1->pic_tuozhan_route; ?>"></td>
