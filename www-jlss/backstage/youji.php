...
<div class="stat_list">
	<ul>
		<li class="now"><a href="youji.php">攻略游记</a></li>
		<li ><a href="youji_insert1.php" >增加一条游记信息</a></li>
	</ul>
</div>
<?
...
<td><?php echo $j++;?></td>
<td><?php echo $info->youji_title;?></td>
<td><?php echo $info->time;?></td>
<td><?php echo $info->author;?></td>
<td><?php echo $info->youji_details;?></td>
<td><?php echo $info->pic_youji_route;?></td>
<td><a href="youji_update1.php?id=<?php echo $info->youji_id ;?>">修改</a></td>
<td><a href="youji_delete.php?id=<?php echo $info->youji_id ;?>">删除</a></td>
</tr>
<?php 
$i++;
}
...
<!--千万要注意超链接中双引号的位置，？前面，page=后面都没有"!!! -->
                                    <td><a href="youji.php?page=1"> 首页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="youji.php?page=<?php echo $last; ?>">上一页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="youji.php?page=<?php echo $next; ?>">下一页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="youji.php?page=<?php echo $pagecount; ?>">尾页</a></td>
</tr>
</table>
</body>
</html>
