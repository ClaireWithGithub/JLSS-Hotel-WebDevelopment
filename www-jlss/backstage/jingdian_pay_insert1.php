...
<div class="stat_list">
	<ul>
		<li ><a href="jingdian_pay.php">查看</a></li>
		<li class="now"><a href="jingdian_pay_insert1.php" >增加一条记录</a></li>
	</ul>
</div>
<?
...
?>
<form method="POST" name="myform" action="jingdian_pay_insert2.php" target="_self">
...
?>
	      ...
	      <td class="input"><select name="jingdian">
<?php 
