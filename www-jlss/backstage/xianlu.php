...
<div class="stat_list">
	<ul>
		<li class="now"><a href="xianlu.php">线路表</a></li>
		<li ><a href="xianlu_insert1.php" >增加一条线路</a></li>
	</ul>
</div>
<?
...
<td><a href="xianlu_update1.php?id=<?php echo $info->xianlu_id ;?>">修改</a></td>
<td><a href="xianlu_delete.php?id=<?php echo $info->xianlu_id ;?>">删除</a></td>
</tr>
<?php 
$i++;
}
...
<!--千万要注意超链接中双引号的位置，？前面，page=后面都没有"!!! -->
                                    <td><a href="xianlu.php?page=1"> 首页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="xianlu.php?page=<?php echo $last; ?>">上一页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="xianlu.php?page=<?php echo $next; ?>">下一页</a>&nbsp;&nbsp;&nbsp;</td>
                                    <td><a href="xianlu.php?page=<?php echo $pagecount; ?>">尾页</a></td>
</tr>
</table>
</body>
</html>
