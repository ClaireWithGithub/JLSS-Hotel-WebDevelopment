...
<div class="stat_list">
	<ul>
		...
		<li class="now"><a href="#" >修改游记信息</a></li>
	</ul>
</div>
<?
...
$sql='select * from youji where youji_id='.$_GET["id"];//用连接符
$result=mysql_query($sql);
$info=mysql_fetch_object($result);
?>
<form method="POST" name="myform" action="youji_update2.php" target="_self" enctype="multipart/form-data">
<table cellpadding="2" cellspacing="1" class="table">
          <tr>
	      <td class="text"><span class="bi_tian">*</span>标题：</td>
	      <td class="input"><input name="title" type="text" class="text" value="<?php echo $info->youji_title; ?>"/></td>
	      </tr>  
           <tr>
	      <td class="text"><span class="bi_tian">*</span>时间：</td>
	      <td class="input"><input name="time" type="text" class="text" value="<?php echo $info->time; ?>"/>
         </td>
	      </tr>
           <tr>
	      <td class="text"><span class="bi_tian">*</span>作者：</td>
	      <td class="input"><input name="author" type="text" class="text" value="<?php echo $info->author; ?>"/>
         </td>
	      </tr>  
	    <tr>
	    ...
	    <tr>
	      <td colspan="2" class="text"><textarea rows="30" cols="50" name="editor01"><?php echo $info->youji_details; ?></textarea>
	    ...
	    <tr>
          ...
          <input type="hidden" name="update1" value="<?php echo $info->pic_youji_route; ?>"></td>
