...
<div class="stat_list">
	<ul>
		...
		<li class="now"><a href="local_insert1.php" >增加一条信息</a></li>
	</ul>
</div><?
...
?>
<form method="POST" name="myform" action="local_insert2.php" target="_self"  onSubmit="return s();" enctype="multipart/form-data">
