...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	...
	<div id="content-wrapper">
		<div class="container">
			...
			<div class="whole-width crumbs">
				<a href="index.php">首页</a><a href="jingdianmenpiao.php">景点门票</a>景点详情页
			</div>
		</div>
		<!-- title -->
		<div class="title">
	...
	<div class="container">		
			...
			<div class="column two-thirds1">
				<div class="gallery">
					<div class="gallery-container">
						<ul>
                        <?php 
			$sql22="select * from pic_jingdian where jingdian_id=".$_GET[id2];
			...
			$info22=mysql_fetch_object($result22);
				?>
		<li><img src="<?php echo $info22->pic_jingdian_route;?>" alt="" /> <span class="over-bg-portfolio"></span></li>
						<?php 
						$i22++;
            }
			?>
			...
			<div class="column one-third1 portfolio-text">
             <?php 
			$sql2="select * from jingdian where jingdian_id=".$_GET[id2];
			...
			$info2=mysql_fetch_object($result2);
				?>
				<h1><mark><?php echo $info2->jingdian_name;?></mark></h1>
				<div class="dbl-dott-wrapper"></div>
				<div class="category-project"><strong><h2><mark>景区等级:</mark><?php echo $info2->rank;?> </h2></strong></div>
				<div class="category-project"><strong><h2><mark>景区主题:</mark><?php echo $info2->theme;?></h2></strong></div>
                <div class="category-project"><strong><h2><mark>景点地址:</mark><?php echo $info2->jingdian_dizhi;?> </h2></strong></div>	
                <div class="category-project"><strong><h2><mark>支付方式:</mark><p>
                 <?php 
			$sql="select * from v_jingdian_pay where jingdian_id=".$_GET[id2];
			...
			<div class="separator9"></div>
             ...
             <!--<h3 class="sub-title">*********</h3>-->
                ...
                <h1><mark>景点介绍</mark>Introduction</h1>
            <?php 
			$sql22="select * from pic_jingdian where jingdian_id=".$_GET[id2];
			$result22=@mysql_query($sql22) or die(mysql_error());
			$i22=1;
			...
			$info22=mysql_fetch_object($result22);
				?>
            <img src="<?php echo $info22->pic_jingdian_route;?>" width="300" height="200">
               <?php 
			   $i22++;
			  }
			   ?>
                <center><p><?php echo $info2->jingdian_details;?></p></center>
		</div>
	</div>
	<!-- end content -->
