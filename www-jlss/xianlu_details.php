	...
	<div id="content-wrapper">
		<div class="container">
			...
			<div class="whole-width crumbs">
				 <a href="lvyouxianlu.php">旅游线路</a>线路详情页
			</div>
		</div>
		<!-- title -->
		<div class="title">
			...
			<div class="container">
                ...
                <?php 
			$sql22="select * from xianlu where xianlu_id=".$_GET[id3];
			$result22=@mysql_query($sql22) or die(mysql_error());
			$info22=mysql_fetch_object($result22);
				?>
					<h1><?php echo $info22->xianlu_title;?></h1>
				</div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<div class="container">
			...
			<!-- Left Part -->
			<div class="columns twelve" style="width: 900px;">
				<!-- Blog Item -->
				<div class="post-entry">
					<!--<h2><a href="blog-page.html">Many variations of passages.</a></h2>-->
					
					<div class="post-body" style="width: 900px;">
						<div class="post-image2">
                     <center>   <img src="<?php echo $info22->pic_xianlu_route;?>" style=" width: 700px;height: 400px;" alt="" /> </center>
                        <span class="over-bg-portfolio"><!-- over --></span></div>
						<div class="post-details">
							<!--<span class="post-autor">by Roman Polyarush</span>
							<span class="post-tags">Responsive</span>
							<span class="post-views">105 views</span>-->
						</div>
					<center>	<p><?php echo $info22->xianlu_details;?></p></center>
