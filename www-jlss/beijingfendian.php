		...
		<div id="header-middle">
			<div class="container">
				...
				<div class="one-third column info">
					<div class="phone">
						<img src="layout/styles/images/backgrounds/kefu.png">客服电话: <strong><mark>010-69940652/53</mark></strong>
					</div>
					<div >
						<!-- src ->  grey; 
							 data-icon -> colored -->
	...
	<div id="content-wrapper">
		<div class="container">
			...
			<div class="whole-width crumbs">
				 <a href="index.php">酒店快捷导航</a>北京分店			
			</div>
		</div>
		<!-- title -->
		<div class="title">
		...
		<div class="container">
			...
			<div class="content-line">
				...
				<div class="column two-thirds inner-page-content">
                  <?php 
			$sql="select * from v_middle_fendian where fendian_name like '%北京%'";
			...
			$info=mysql_fetch_object($result);
				?><a href="fendian_details.php?id1=<?php echo $info->fendian_id;?>">
					<img src="<?php echo $info->pic_fendian_route;?>" alt="" width="350" height="233"/></a>
					<div class="sep4"></div>					
					<h3><a href="fendian_details.php?id1=<?php echo $info->fendian_id;?>">
					<?php echo $info->fendian_name;?></a></h3>
					<h4>价格：<?php echo $info->price;?>起</h4>
					<p><?php echo iconv_substr($info->fendian_details,0,100,'gbk'); ?></p>
