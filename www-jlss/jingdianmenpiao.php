...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	...
	<div id="content-wrapper">
		...
		<div class="title">
			...
			<div class="container">
                ...
                <h3 style="float:right;"> <a href="beijingmenpiao.php">更多</a></h3>
		...
		<div class="container">
			...
			<div class="full-width">
				...
				<ul class="block-filtered-items portfolio-4c">
				 <?php 
			$sql="select * from v_banner_jingdian where jingdian_name like '%北京%'";
				...
				?>
					<li class="element photography">
						<div class="portfolio-shadow">
							<a href="jingdian_details.php?id2=<?php echo $info->jingdian_id;?>" class="">
                            <img src="<?php echo $info->pic_jingdian_route;?>" alt="" /> 
                        ...
                        <?php echo $info->jingdian_name;?></a></div>
   ...
   <div class="title">
			...
			<div class="container">
                ...
                <h3 style="float:right;"><a href="hebeimenpiao.php">更多</a></h3>
                </div>
		</div>
    <div class="container">
			<div class="separator39"></div>
			...
			<div class="full-width">
				<div class="portf">
                	<ul class="block-filtered-items portfolio-4c">
				 <?php 
			$sql="select * from v_banner_jingdian where jingdian_name like '%河北%'";
			$result=@mysql_query($sql) or die(mysql_error());
			$num=mysql_num_rows($result);
			$i=1;
			while($i<=$num){
			$info=mysql_fetch_object($result);
				?>
					<li class="element photography">
						<div class="portfolio-shadow">
							<a href="jingdian_details?id2=<?php echo $info->jingdian_id;?>" >
                            <img src="<?php echo $info->pic_jingdian_route;?>" alt="" /> 
                            </a>
						</div>
						<div class="portfolio-page-link">
