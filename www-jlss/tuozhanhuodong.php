			...
			<div class="header-bottom-wrapper">
				<div class="twelve columns alpha" id="main-menu-wrapper">
                    ...
                    <li>
						...
						<li><a class="active" href="tuozhanhuodong.php">拓展活动</a></li>
	...
	<div id="content-wrapper">
		...
		<div class="container">
			...
			$info=mysql_fetch_object($result);
				?>
				<img src="<?php echo $info->pic_tuozhan_route;?>" alt=""  width="900px" height="1200px"/>
			<!--	<h3>We're sorry, but the page you were looking for doesn't exist.</h3>
				<p>You can start from the <a href="index.html">home page</a>, read the <a href="blog.html">blog</a> or <br /> see the our <a href="portfolio-page.html">portfolio</a>.</p>
			--></div>
		</div>
	</div>
	<!-- end content -->
